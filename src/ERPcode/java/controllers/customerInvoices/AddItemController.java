...
public class AddItemController {
    ...
    private void QalqulateTotal(KeyEvent event) {
        ...
        //if discount is blank, add 0.0 to avoid null exceptions
    ...
    private void InsertItemToTable(ActionEvent event) throws IOException {
        ...
        NewCustomerInvoiceController.getInstance().addItemToList(transaction);
        ...
        NewCustomerInvoiceController.getInstance().OpenAddItemWindow(event);
