...
public class EditItemController {
    ...
    void UpdateItem(ActionEvent event) {
        ...
        ItemTransaction transaction = new ItemTransaction(null, Date, Time, Code, Description, Quantity, Price, VatValue, Discount, Etiology, Total, 300, InvoiceID);

        // use update method from new customer invoice controller where it sets to the list the edited item
        NewCustomerInvoiceController.getInstance().updateItemToList(transaction);
    ...
    void SearchItemByBarcode(ActionEvent event) throws IOException {
        ...
        itemSelectionController.openedFrom("from new customer invoice edit item");
