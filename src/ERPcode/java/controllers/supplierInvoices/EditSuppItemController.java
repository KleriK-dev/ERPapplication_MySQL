...
public class EditSuppItemController {
    ...
    private static EditSuppItemController instance;

    public EditSuppItemController(){
        instance = this;
    }

    public static EditSuppItemController getInstance(){
        return instance;
    }
    ...
    void SearchItemByBarcode(ActionEvent event) throws IOException {
        ...
        itemSelectionController.openedFrom("from new supplier invoice edit item");
        itemSelectionController.loadDataByBarcode(barcode.getText().trim()); //load data of the inputed barcode
        itemSelectionController.getCustomerOrSupplierID(supplier_id.getText()); //pass customer id to item selection
    ...
    @FXML
    void SearchItemByCode(ActionEvent event) throws IOException {
    ...
    @FXML
    void SearchItemByDescription(ActionEvent event) throws IOException {
    ...
    void UpdateItem(ActionEvent event) {
        ...
        NewSupplierInvoiceController.getInstance().updateItemToList(transaction);
