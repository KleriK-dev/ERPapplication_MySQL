...
public class AddSuppItemController {
    ...
    @FXML
    private TextField supplier_id; //hidden
    ...
    private static AddSuppItemController instance;

    public AddSuppItemController(){
        instance = this;
    }

    public static AddSuppItemController getInstance(){
        return instance;
    }
    ...
    private void InsertItemToTable(ActionEvent event) throws IOException {
        ...
        ItemTransaction transaction = new ItemTransaction(null, Date, Time, Code, Description, Quantity, Price, VatValue, Discount, Etiology, Total, 200, InvoiceID);

        // use add item to list from new customer invoice controller that adds to the list a ItemTransaction object
        NewSupplierInvoiceController.getInstance().addItemToList(transaction);
        ...
        NewSupplierInvoiceController.getInstance().OpenAddItemWindow(event);
    ...
    @FXML
    private void SearchItemByBarcode(ActionEvent event) throws IOException {
        ...
        itemSelectionController.openedFrom("from new supplier invoice add item");
        itemSelectionController.loadDataByBarcode(barcode.getText().trim()); //load data of the inputed barcode
        itemSelectionController.getCustomerOrSupplierID(supplier_id.getText()); //pass supplier id to item selection
    ...
    public void loadDataForTransaction(String supplierID, String invoiceID, String Date, String Time){
